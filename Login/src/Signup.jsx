...
function Signup({Added}) {
    ...
    const [signup,setSignup]=useState({name:"",email:"",password:"",mob:"",role:"Admin"})
  ...
  return (
    <div>
        <form onSubmit={Form}>
            ...
            <br />
            <input type="text" name='password' value={signup.password} onChange={Input} />
            <br />
            <br />
            <label htmlFor="Mobile">Mobile :</label>
            <br />
            <input type="text" name='mob' value={signup.mob} onChange={Input} />
            <br />
            <br />
